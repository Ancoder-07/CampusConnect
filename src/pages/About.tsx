          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="reveal relative mb-10"
              ...
              <span className="absolute -top-10 left-0 text-7xl md:text-9xl font-black text-gray-100 uppercase tracking-tighter select-none -z-0 pointer-events-none">
                {t('about_page.vision_watermark','Vision')}
              </span>
              <div className="relative z-10 flex items-center gap-3">
                <div className="grow-line h-1.5 rounded-full" style={{ background:'#0d9488' }}></div>
                <span className="font-bold uppercase tracking-[0.4em] text-[10px]" style={{ color:'#0d9488' }}>
                  {t('about_page.vision_mission_label','VISION & MISSION')}
                </span>
              </div>
            </div>

            <div ref={visionRef} className="stagger-grid grid grid-cols-1 md:grid-cols-2 gap-8">

              {/* Vision — teal accent */}
              <div className="card-lift group relative bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden">
                ...
                <div className="p-8">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center transition-all duration-500"
                         style={{ background:'#f0fdfa', color:'#590d94' }}
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed font-medium">{t('about_page.vision_text')}</p>
                </div>
              </div>
              ...
              <div className="card-lift group relative bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden">
                ...
                <div className="p-8">
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed font-medium">{t('about_page.mission_text')}</p>
                </div>
              </div>
            </div>
          </div>
